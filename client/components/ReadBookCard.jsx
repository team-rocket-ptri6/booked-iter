        ...
        <div className="p-6 flex flex-col justify-start w-full">
          ...
          <div className="flex">
            ...
            {book.rating ? (
              ...
              <p className="text-gray-600 text-sm">{" No rating yet"}</p>
            )}
          </div>
          ...
          <div className="flex">
            <p className="text-gray-600 text-sm">My review: </p>
            <p className="text-gray-600 text-sm">
              {book.review ? book.review : "No review added"}
            </p>
          </div>
          <div>
            <button
          ...
          transition duration-150 ease-in-out"
            ...
            {showRatingModal ? <ReadBookRatingModal /> : <></>}
          </div>
        </div>
      </div>
    </div>
