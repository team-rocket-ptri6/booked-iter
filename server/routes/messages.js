...
*/
router.delete('/:messageId',jwtController.verifyToken, /** add middleware */ (req, res) => {
 ...
 */
router.post('/new/:clubId',jwtController.verifyToken, /** add middleware */ (req, res) => {
  res.status(200).json(res.locals);
});
 ...
 * Idetify club with clubId
 */
router.get('/:clubId', jwtController.verifyToken, /** add middleware */ (req, res) => {
  res.status(200).json(res.locals);
});
...
*/
router.put('/:messageId', jwtController.verifyToken, /** add middleware */ (req, res) => {
  res.status(200).json(res.locals);
});
